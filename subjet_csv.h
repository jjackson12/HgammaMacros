...
// Tue May  3 15:20:36 2016 by ROOT version 6.06/02
// from TTree tree/tree
// found on file: flatTuple_Hgamma_m750.root
//////////////////////////////////////////////////////////
...
#ifdef subjet_csv_cxx
subjet_csv::subjet_csv(TTree *tree) : fChain(0) 
{
...
subjet_csv::~subjet_csv()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t subjet_csv::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t subjet_csv::LoadTree(Long64_t entry)
{
...
void subjet_csv::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("sys_weights", &sys_weights, &b_sys_weights);
...
void subjet_csv::Show(Long64_t entry)
{
...
Int_t subjet_csv::Cut(Long64_t entry)
{
