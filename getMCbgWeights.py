...
def getMCbgColors():
  ...
  sampleColors["2016GJets100-200.root" ] = color.GetColor(.475, .6, 1.0)
  sampleColors["2016GJets200-400.root" ] = color.GetColor(.35, .5, 0.85)
  sampleColors["2016GJets400-600.root" ] = color.GetColor(.225, .3, 0.7)
  sampleColors["2016GJets600-Inf.root" ] = color.GetColor(.1, .1, 0.55) 
  sampleColors["2016QCD200-300.root"   ] = color.GetColor(.31, .95, 0.425)
  sampleColors["2016QCD300-500.root"   ] = color.GetColor(.28, .9, 0.4)
  sampleColors["2016QCD500-700.root"   ] = color.GetColor(.25, .8, 0.375)
  sampleColors["2016QCD700-1000.root"  ] = color.GetColor(.22, .7, 0.35)
  sampleColors["2016QCD1000-1500.root" ] = color.GetColor(.19, .6, 0.325)
  sampleColors["2016QCD1500-2000.root" ] = color.GetColor(.16, .5, 0.3)
  sampleColors["2016QCD2000-Inf.root"  ] = color.GetColor(.13, .4, 0.275)
