...
#for file in "${data[@]}"; do python runHbbGammaSelector.py ~/physics/dec17_ntuples/fragments/dataFrags/Hgamma_Dec17_${file}.root 80XDDs_Dec13/dataFrags/ddTree_Dec18_${file}.root load & done
